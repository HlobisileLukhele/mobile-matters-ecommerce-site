...
const SignIn = () => {
  ...
  return (
     <div className='container-fluid sign-in-container justify-content-center'>
      <form onSubmit={signIn} id="signin" className="form" >
    <h4>Log in to your Account</h4>
   <div className="flex-column">
    <label className="align-right">Email </label>
  </div>
  ...
  <div className="flex-column">
    <label className="align-right">Password </label>
  </div>
  <div className="inputForm">
    <svg
      height={20}
